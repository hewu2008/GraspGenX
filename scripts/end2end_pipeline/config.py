...
APPROACH_MAX_TRANS_SPEED_MPS = 0.2   # max end-effector translation speed (m/s)
APPROACH_MAX_ANG_SPEED_RPS = 0.6     # max end-effector rotation speed (rad/s)
APPROACH_MIN_DURATION_S = 1.0        # floor on the approach duration (s)
